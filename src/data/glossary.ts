...
export const GLOSSARY: GlossaryCategory[] = [
  ...
  },
  {
    ...
    emoji: "⚡",
    terms: [
      { term: "Relay Plans", def: "Relay's planning module — connects roadmap items and sprint commitments to delivery signals so status reflects real build and deploy activity, not just ticket updates.", seeAlso: "SDLC" },
      { term: "Relay Code", def: "Relay's inner-loop module for AI-assisted coding, code review, and repository intelligence — accelerating how developers write, review, and understand code." },
      { term: "Relay Deploy", def: "Relay's continuous delivery module — orchestrates pipelines, approvals, and progressive rollouts across cloud, Kubernetes, and serverless targets." },
      { term: "Relay Verify", def: "Relay's automated testing and verification module — runs test suites, detects flaky tests, and provides test-intelligence analytics to improve pipeline reliability." },
      { term: "Relay Secure", def: "Relay's supply-chain security module — integrates SAST, SCA, SBOM generation, and policy enforcement directly into the delivery pipeline.", seeAlso: "SAST, SCA, SBOM" },
      { term: "Relay Cloud Costs", def: "Relay's FinOps module — surfaces idle resources, recommends right-sizing, and tracks cost anomalies with automated governance rules.", seeAlso: "FinOps, Right-Sizing" },
      { term: "Relay Reliability", def: "Relay's SRE and chaos module — defines SLOs, manages error budgets, and runs controlled failure experiments to verify resilience.", seeAlso: "SRE, SLO, Chaos Engineering" },
    ],
  },
];
